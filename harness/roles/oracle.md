...
claim that advice proves correctness. The adapter routes back to the requesting role.
Use task.blocked if a material owner decision is required or no actionable investigation
can proceed with the available evidence. Harbor's reference-solution Oracle is unrelated.
