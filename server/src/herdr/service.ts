...
export const HERDR_SERVICE_MARKER = "Generated by herdr-world herdr setup.";
export const HERDR_SERVICE_LABEL = "dev.herdr-world.herdr";
...
export function resolveHerdrServicePaths(
  ...
  return {
    ...
    stdoutLog: join(homeDir, "Library", "Logs", "herdr-world-herdr.stdout.log"),
    stderrLog: join(homeDir, "Library", "Logs", "herdr-world-herdr.stderr.log"),
  };
}
...
[Unit]
Description=Herdr server (managed by Herdr World)
...
function assertHerdrDefinitionWritable(path: string) {
  if (
    ...
    throw new Error(
      `${path} was not generated by herdr-world; remove it yourself before rerunning herdr setup`,
    );
  }
}
