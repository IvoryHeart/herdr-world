...
<title>Herdr World login</title>
<link rel="icon" type="image/png" href="/herdr-world-icon-192.png">
<style>
...
<body>
<main>
  <div class="brand"><img src="/herdr-world-icon-192.png" alt="" width="48" height="48"><span>Herdr World</span></div>
  <section class="card" aria-labelledby="heading">
    ...
    <noscript><p class="err">Enable JavaScript to log in to Herdr World.</p></noscript>
  </section>
