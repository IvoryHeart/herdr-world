...
| Shared pane watches and visual Actions | [World surfaces](../openspec/specs/world-surfaces/spec.md) | `server/src/world/watchlist.ts`, `web/src/world/WorldFoundationApp.tsx`, `web/src/world/VisualRouteActionsMenu.tsx`, `web/src/world/visualRouteActions.ts` |
