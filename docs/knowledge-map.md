...
| Agent development and evals | [Agent development](../openspec/specs/agent-development/spec.md) | [Agent development](agent-development.md), [Pilot guide](agent-pilots.md), `harness/`, `scripts/agent/`, `evals/` |
