...
| Office, Graph, Spaces and optional observations | [World surfaces](../openspec/specs/world-surfaces/spec.md) | `web/src/world/worldModel.ts`, `worldRuntime.ts`, `herdrOfficeProjection.ts`, `graph/`; `web/src/AppShell.tsx`, `surfaceRegistry.ts`; [observability](observability.md), [assets](world-assets.md) |
