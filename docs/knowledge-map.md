...
| Aggregate WorldObject, Spaces, Office, Tree, Graph and shared pane watches | [World surfaces](../openspec/specs/world-surfaces/spec.md) | `server/src/world/snapshot.ts`, `server/src/world/watchlist.ts`, `web/src/world/`, `web/src/App.tsx`, [features](../FEATURES.md) |
