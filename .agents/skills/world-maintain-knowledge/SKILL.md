---
name: world-maintain-knowledge
description: Update Herdr World's current specs, source map and runbooks when a change makes them inaccurate.
---

Use docs/knowledge-map.md to locate ownership. Update a capability spec for changed
