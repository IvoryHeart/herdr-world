...
import { expectHostState, hostTrigger, openHostMenu, openView, selectAllHosts, selectHostById, selectSpaceScope, selectView, viewSelect } from "./sidebarControls";
...
for (const [chunk, view] of [["WorldThemeStage", "Office"], ["TreeTheme", "Tree"], ["GraphTheme", "Graph"]] as const) {
