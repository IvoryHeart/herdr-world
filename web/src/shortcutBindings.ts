...
const base = {
  ...
  "arrangement.single": ["Ctrl+Alt+Shift+1"],
  "arrangement.cascade": ["Ctrl+Alt+Shift+2"],
  "arrangement.columns": ["Ctrl+Alt+Shift+3"],
  "arrangement.rows": ["Ctrl+Alt+Shift+4"],
  "arrangement.grid": ["Ctrl+Alt+Shift+5"],
  "arrangement.restore": ["Ctrl+Alt+Shift+6"],
...
export function defaultShortcutBindings(
  ...
  if (platform === "mac")
    Object.assign(bindings, {
      ...
      "arrangement.single": ["Ctrl+Meta+Shift+1"],
      "arrangement.cascade": ["Ctrl+Meta+Shift+2"],
      "arrangement.columns": ["Ctrl+Meta+Shift+3"],
      "arrangement.rows": ["Ctrl+Meta+Shift+4"],
      "arrangement.grid": ["Ctrl+Meta+Shift+5"],
      "arrangement.restore": ["Ctrl+Meta+Shift+6"],
