...
export type ToolbarPrimaryView = "spaces" | "office" | "graph";
        ...
        <div className="toolbar-select toolbar-view-select">
          ...
          <div className="toolbar-view-control">
            ...
            {onOpenCurrentView ? <button type="button" className="toolbar-open-view"
              aria-label={`Open ${view === "graph" ? "Graph" : "Office"} view`}
              title={`Open ${view === "graph" ? "Graph" : "Office"} view`} onClick={onOpenCurrentView}>
