...
export const AGENT_ICON_GLYPHS: Readonly<Record<AgentIconKind, AgentIconGlyph>> = {
  claude: {
    viewBox: "0 0 256 257",
    paths: [{
  ...
  opencode: {
    ...
    fill: "none",
    paths: [
      { d: "M24 32H8V16H24V32Z", fill: "currentColor", opacity: 0.45 },
      { d: "M24 8H8V32H24V8ZM32 40H0V0H32V40Z", fill: "currentColor" },
    ],
  },
  pi: {
    viewBox: "0 0 800 800",
...
export function AgentIcon({ kind }: { kind: AgentIconKind }) {
  ...
  return (
    <svg
      className={`agent-icon agent-icon-${kind}`}
