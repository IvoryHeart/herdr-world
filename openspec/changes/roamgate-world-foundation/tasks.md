...
- [ ] 9.1 Replace the terminal-only floating presentation with the reusable Inspector surface and one qualified registry entry per entity; verify selecting an entity from either the common navigator or a visual opens/focuses the matching docked Inspector without implicitly floating the replaced docked entity, desk activation opens/focuses its floating Inspector on Terminal, and the same entity never acquires duplicate resource or terminal ownership
