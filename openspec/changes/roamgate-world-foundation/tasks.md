...
- [ ] 3.4 Complete the connected Tree and spatial Graph migrations in tasks 11.1–12.4 and verify both distinct presentations, guarded actions and compact/accessibility equivalents
...
- [ ] 5.3 Run final responsive browser acceptance on the completed Office, Tree and Graph ports at desktop and phone sizes, and publish privacy-safe synthetic captures that demonstrate the required compositions
...
- [ ] 11.1 Move the checkpoint connected branch diagram from Graph to canonical Tree and replace the list-primary desktop composition, preserving exact host-space-agent/terminal connectors
...
- [ ] 11.3 Integrate the shared detail drawer and terminal conversations while retaining an equivalent compact/assistive hierarchy, and verify stale actions, task summaries and keyboard/touch operation
...
- [ ] 12.3 Integrate the shared detail drawer, semantic hierarchy and terminal conversation connectors, and verify canvas and semantic selection/actions stay synchronized
