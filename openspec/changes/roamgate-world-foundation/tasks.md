...
- [ ] 9.1 Present one focused Office conversation through the current Roamgate-derived `TerminalView`, terminal support machinery and shell-owned browser connection, suppress a competing mounted-but-hidden Spaces terminal view, and verify repeated selection of the same qualified agent or desk focuses the existing attachment without duplicate input or transport
