...
- [ ] 9.1 Replace the terminal-only floating presentation with the reusable Inspector surface and one qualified registry entry per entity; verify selecting an entity opens/focuses the docked Inspector, desk activation opens/focuses its floating Inspector on Terminal, and the same entity never acquires duplicate resource or terminal ownership
