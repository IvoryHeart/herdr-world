...
Keep Spaces and a deep Pixel Office as native presentations over one qualified runtime projection,
one focused Inspector and one terminal owner. See
...
survive browser refresh, SHALL remain distinct from workspace pins, and
